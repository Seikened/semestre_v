...
trabajadores = np.random.randint(1, 6, size=1000000).tolist()
...
print(
    f"Tiempo estricto para generar la lista de trabajadores: {tiempo_generar_lista:.2f} segundos"
)
print(
    f"Tiempo estricto para aplicar el incremento: {tiempo_incremento_salario:.2f} segundos"
)
