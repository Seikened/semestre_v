...
# Nuestra rutina principal. Comprueba el funcionamiento de MPI y ejecuta el código correcto
def main():
    # type: () -> int
...
def mpi_root(mpi_comm):
   ...
   ¡Listo!
    ...
    # Recopila todas nuestras respuestas. `gather()` toma un parámetro, que para la raíz es `None`. 
    ...
    for i in range(1, mpi_size):
        ...
        # Envía al trabajador un mensaje MPI unidireccional que indica "¡Puedes salir ahora!". 
