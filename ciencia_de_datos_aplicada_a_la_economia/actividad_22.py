...
lista_empresas = []
tickers = ['AMX']
lista_empresas.append (yf.download("AMX", start="2024-01-01", end="2025-01-01")['Close']) # type: ignore
os.system("clear")
...
for empresa,ticker in zip(lista_empresas,tickers):
    ...
    print("--------- sortino ------------")
    print(f"Exceso diario prom.  : {exceso:.4%}")
    print(f"Vol. a la baja diaria: {sigma_down_diaria:.4%}")
